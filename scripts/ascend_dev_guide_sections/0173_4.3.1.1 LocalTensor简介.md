...
| LocalTensor | 构造函数<br>产品支持情况<br>产品是否支持（Pipe 是否支持（静态框架） Tensor编程）<br>Atlas A3 训练系列产品/Atlas A3 推理系列 √ √产品<br>Atlas A2 训练系列产品/Atlas A2 推理系列 √ √产品<br>Atlas 200I/500 A2 推理产品 √ x<br>Atlas 推理系列产品AI Core √ √<br>Atlas 推理系列产品Vector Core √ √<br>Atlas 训练系列产品 √ x<br>功能说明<br>LocalTensor构造函数。 |
