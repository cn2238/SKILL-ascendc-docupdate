...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| b | 输入 | C矩阵Layout的B轴信息<br>s 输入 C矩阵Layout的S轴信息<br>n 输入 C矩阵Layout的N轴信息<br>g 输入 C矩阵Layout的G轴信息<br>d 输入 C矩阵Layout的D轴信息<br>返回值说明<br>- 1表示设置失败； 0表示设置成功。 |
