...
if update == False:x_mean = rowMeanGlobal
...
struct SoftMaxParams {
 ...
 uint32_t loopCnt; // update为true时，公式中的循环次数loopCnt，该参数大
```

于等于1 uint32_t splitMeanCnt; // 公式中计算每一行平均值时的分块个数，当前该参数仅支持取值为8 float alpha; // 公式中的计算参数，推荐取值0.9375、0.96889、0.984497
