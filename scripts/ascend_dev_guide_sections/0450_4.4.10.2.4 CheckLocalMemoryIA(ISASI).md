...
| isScalarRe | Check标量读访问。ad ●false：不开启，默认为false。 |
| - | true：开启。 |
| isScalarW | Check标量写访问。rite ●false：不开启，默认为false。 |
| - | true：开启。 |
| isVectorRe | Check矢量读访问。ad ●false：不开启，默认为false。 |
| - | true：开启。 |
| isVectorW | Check矢量写访问。rite ●false：不开启，默认为false。 |
| - | true：开启。 |
| isMteRea | Check Mte读访问。d ●false：不开启，默认为false。 |
| - | true：开启。 |
| isMteWrit | Check Mte写访问。e ●false：不开启，默认为false。 |
| - | true：开启。 |
