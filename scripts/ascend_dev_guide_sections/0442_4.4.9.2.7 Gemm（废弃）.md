...
| src1 | 输入源操作数，TPosition为B1。<br>m 输入左矩阵Src0Local有效Height，范围：[1, 4096]。<br>注意：m可以不是16的倍数。<br>k 输入左矩阵Src0Local有效Width、右矩阵Src1Local有效Height。<br>- 当输入张量Src0Local的数据类型为float时，范围：<br>[1, 8192]<br>- 当输入张量Src0Local的数据类型为half时，范围：[1,<br>16384]<br>- 当输入张量Src0Local的数据类型为int8_t时，范围：<br>[1, 32768]注意：k可以不是16的倍数。<br>n 输入右矩阵Src1Local有效Width，范围：[1, 4096]。<br>注意：n可以不是16的倍数。 |
