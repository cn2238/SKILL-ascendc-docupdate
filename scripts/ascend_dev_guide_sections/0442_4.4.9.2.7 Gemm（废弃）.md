...
| kNum | uint32_t K轴等效数据长度参数值。<br>- 当输入张量Src0Local的数据类型为float时，<br>范围：[1, 8192]<br>- 当输入张量Src0Local的数据类型为half时，范<br>围：[1, 16384]<br>- 当输入张量Src0Local的数据类型为int8_t时，<br>范围：[1, 32768] |
