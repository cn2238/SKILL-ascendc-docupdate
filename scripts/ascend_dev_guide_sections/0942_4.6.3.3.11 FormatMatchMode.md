...
option 输入匹配模式配置参数，类型为FormatCheckOption枚举类。支持以下几种取值：

- DEFAULT：对NCHW/NHWC/DHWCN/
### NCDHW/NCL格式的输入输出转成ND格式进行处

理；

- STRICT：对数据格式需要严格区分，针对NCHW/
NHWC/DHWCN/NCDHW/NCL格式，aclnn框架侧不做转换处理。
