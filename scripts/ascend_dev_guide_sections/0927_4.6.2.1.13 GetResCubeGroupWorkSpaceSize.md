...
| 参数名 | 输入/输出 | 说明 |
| --- | --- | --- |
| ReservedSiz | 输入 | 需要预留的空间大小。<br>`e enum class ReservedSize {`<br>`RESERVED_SIZE_8K, // 预留8 * 1024B空间`<br>RESERVED_SIZE_16K, // 预留16 * 1024B空间RESERVED_SIZE_32K, // 预留32 * 1024B空间<br>`};` |
