...
srcNdStrid 输入以分形大小为单位的源步长，源相邻nz矩阵的偏移（头与e 头）。

Atlas A2 训练系列产品/Atlas A2 推理系列产品，srcNdStride∈[1, 512]，单位：fractal_size 1024B。Atlas A3 训练系列产品/Atlas A3 推理系列产品，srcNdStride∈[1, 512]，单位：fractal_size 1024B。Atlas 200I/500 A2 推理产品，srcNdStride∈[1, 512]，单位：fractal_size 1024B。

dstNdStrid 输入目的相邻nd矩阵的偏移（头与头）。单位为元素。e Atlas A2 训练系列产品/Atlas A2 推理系列产品，dstNdStride∈[1, 65535]。
