...
| sharedTmpBuffer | 输入 | 临时缓存。<br>类型为LocalTensor，支持的TPosition为VECIN/VECCALC/VECOUT。 |
...
结果示例如下：输入数据(srcLocal): [2.015634 , -2.3880906, -0.2151161, ..., -2.5 , 0. , 2.5]输出数据(dstLocal): [0.99563545, -0.999268 , -0.23903976, ..., -0.9995931 , 0. , 0.9995931]
