...
| 参数名称 | 输入/输出 | 含义 |
| --- | --- | --- |
| outputPdX | 输出目的操作数，shape为[B, | S, H]，LocalTensor数据结构的定义请参考4.3.1 LocalTensor。尾轴长度需要32B对齐。 |

类型为LocalTensor，支持的TPosition为VECIN/VECCALC/VECOUT。

resForGamm 输出目的操作数，shape为[B, S, H]，LocalTensor数据a 结构的定义请参考4.3.1 LocalTensor。尾轴长度需要32B对齐。
